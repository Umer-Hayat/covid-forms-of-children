$(document).ready(function(){
    ...
    $("#addButton1").click(function () {
      ...
      '<div class="col-md-6"  ><div class="row"><select class="form-control" name="CH_ChildsSex' + counter + '" id="CH_ChildsSex' + counter + '" required value>' + '<option value="">Child\'s Sex</option> <option value="Male">Male</option> <option value="Female">Female</option> </select></div></div>');
        //newTextBoxDiv.appendTo("#TextBoxesGroup");
        $('#TextBoxesGroup div.row:last').after(newTextBoxDiv);
        counter++;
     });		               
