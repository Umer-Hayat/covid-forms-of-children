$(document).ready(function(){
	...
	var newTextBoxDiv = $(document.createElement('div'))
	 ...
	 $('#TextBoxesGroup tr:last').after('<tr id=TextBoxDiv' + counter+'><td class="style6" width="114"><label>' + ' Child\'s First Name: </label></td>' +
	      '<td  class="right"><input size="20" name="CH_ChildsFirstName' + counter + '" class="text"' + 
      ...
      '<td  class="right"><input type="text" required  maxlength="100" maxsize="100"  placeholder="Child\'s Last Name"  name="CH_ChildsLastName' + counter +
      ...
      '<td  class="right"><input type="date" required maxlength="100" maxsize="100"  placeholder="MM/DD/YYYY" name="CH_ChildsDateOfBirth' + counter +
      '" id="CH_ChildsDateOfBirth' + counter + '" value="" >'+ '</td><td class="style6" width="114"><label>' + ' Child\'s Sex: </label>' +
      '</td><td  class="right"><select name="CH_ChildsSex' + counter + '" id="CH_ChildsSex' + counter + '" required value>' + '<option value="">Select One</option> <option value="Male">Male</option> <option value="Female">Female</option> </select></td></tr>');
    ...
    $("#addButton1").click(function () {
        ...
        var newTextBoxDiv = $(document.createElement('div'))
             .attr("id", 'TextBoxDiv' + counter);
         $('#TextBoxesGroup tr:last').after('<tr id=TextBoxDiv' + counter+'><td  class="right"><input size="20" name="CH_ChildsFirstName' + counter + '" class="text"' +
      ...
      '<td  class="right"><div class="styled-select"><select name="CH_ChildsSex' + counter + '" id="CH_ChildsSex' + counter + '" required value>' + '<option value="">Child\'s Sex</option> <option value="Male">Male</option> <option value="Female">Female</option> </select></td></tr>');
        //newTextBoxDiv.appendTo("#TextBoxesGroup");
        $('#TextBoxesGroup tr:last').after(newTextBoxDiv);
        counter++;
     });		               
